...
// Last edited on January 20 of 2019, at 15:46 BRT
...
#define ArchSwitchToKernelStack() Asm Volatile("mov %0, %%rsp" :: "r"(((UIntPtr)(&KernelStack)) + 8192)); GDTSetKernelStack(((UIntPtr)(&KernelStack)) + 8192);
